...
ZIP=/tmp/pango-1.16.4.zip
DEVZIP=/tmp/pango-dev-1.16.4.zip
cd /opt/mipsel-linux-uclibc/usr

mkdir -p share/doc/pango-1.16.4
cp -p /media/Data/dingoo/dingux/dev/openwrt/trunk/build_dir/target-_-/pango-1.16.4/COPYING share/doc/pango-1.16.4

mkdir -p share/doc/pango-dev-1.16.4
cp -p /media/Data/dingoo/dingux/dev/openwrt/trunk/build_dir/target-_-/pango-1.16.4/COPYING share/doc/pango-dev-1.16.4
...
zip -r $ZIP share/doc/pango-1.16.4
...
zip -r $DEVZIP share/doc/pango-dev-1.16.4
